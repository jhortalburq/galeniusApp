...
export class EditIndicacionComponent {
  ...
  onSubmit() {
    if (this.registerForm.valid) {
      ...
      this.mantenimientoService.editObjectMantenimiento('maestros/indicaciones-medicas', this.registerForm.value, this.registro.id, this.sharedService.organizacion_seleccionada.id)
                              .subscribe({
                                next: (response) => {
