...
export class DiagnosticosComponent {
  ...
  getData(url?) {
    this.mantenimientoService.getDataMantenimiento('diagnosticos', this.empresaService.empresa_seleccionada.id).subscribe({
      next: (response: any) => {
  ...
  applyFilter(event: any) {
    ...
    this.mantenimientoService.getDataMantenimiento('diagnosticos', this.empresaService.empresa_seleccionada.id, filterValue).subscribe((response: any) => {
      this.registros = response.results;
    });
  }
}
