...
export class EditAnalisisClinicoComponent {
  ...
  onSubmit() {
    if (this.registerForm.valid) {
      ...
      this.mantenimientoService.editObjectMantenimiento('maestros/analisis', this.registerForm.value, this.registro.id, this.sharedService.organizacion_seleccionada.id)
                              .subscribe({
                                next: (response) => {
